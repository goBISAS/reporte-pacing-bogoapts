...
try:
    ...
    filas_superior = []
    limite_sup = min(31, len(df_raw_roas))
    for r_idx in range(3, limite_sup):
    ...
    # 2. Extracción e indexación de la Tabla Inferior (Filas 33 en adelante)
    filas_inferior = []
...
# ==========================================================
# SECCIÓN 2: ARQUITECTURA VISUAL INDEPENDIENTE (FRONTEND)
# ==========================================================

# Pestañas corporativas principales de navegación
tab_pacing, tab_atribucion = st.tabs(["📊 Rendimiento de Pauta (Pacing)", "📈 Atribución y Retorno"])

# --- RENDER DE PESTAÑA 1: CORE PACING ---
with tab_pacing:
    if pacing_exitoso:
